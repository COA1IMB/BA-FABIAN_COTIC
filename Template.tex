...
\usepackage{color} % allows use of colors
\usepackage{framed} %Notwendig fuer Kaestchen
\usepackage{xcolor} %Notwendig fuer Farbe der Kaestchen
\colorlet{shadecolor}{gray!30} %Farbe der Kaestchen
\theoremstyle{definition}
\newtheorem{definition}{Exkurs} %Notwendig fuer Definition
